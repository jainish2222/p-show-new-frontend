...
function App() {
  ...
  if (loading) return<div className="flex items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <main>
        <div className="">
          <div className="w-3/10">
            <ul className="hidden fixed z-10  h-screen flex flex-col justify-center list-none pl-6 sm:w-88 sm:flex">
              {formData.map((item) => (
                <li
                  key={item._id}
